...
export default class LevelTen extends Phaser.Scene {
  ...
  init() {
    this.cheesesCollected = 470;
    this.CheeseCount = 470;
  }

  create() {
    console.log("create level 10");
  ...
  addCheeseAbove(player) {
    ...
    this.cheeses.create(cheeseX, cheeseY, "lvl10-rat").setScale(0.3);
  }
