...
export default class Loading extends Phaser.Scene {
  ...
  preload() {
    ...
    // ============ Sound ====
    this.load.audio("lvl9-aca", "assets/sfx/lvl9-addcheeseabove.mp3");
    this.load.audio("lvl9-bounce", "assets/sfx/lvl9-bounce.mp3");
    this.load.audio("lvl9-left", "assets/sfx/lvl9-left.mp3");
    this.load.audio("lvl9-loop1", "assets/sfx/lvl9-loop1.mp3");
    this.load.audio("lvl9-loop2", "assets/sfx/lvl9-loop2.mp3");
    this.load.audio("lvl9-restart", "assets/sfx/lvl9-restart.mp3");
    this.load.audio("lvl9-right", "assets/sfx/lvl9-right.mp3");
    this.load.audio("lvl9-unbounce", "assets/sfx/lvl9-unbounce.mp3");
    // ============ Music ====
    this.load.audio("lvl9-song", "assets/sfx/lvl9-song.mp3");
    this.load.audio("lvl9-3song", "assets/sfx/longBeep_.mp3");
    ...
    // ============ Sound ====
    this.load.audio("lvl11-aca", "assets/sfx/lvl11-addcheeseabove.mp3");
    this.load.audio("lvl11-bounce", "assets/sfx/lvl11-bounce.mp3");
    this.load.audio("lvl11-left", "assets/sfx/lvl11-left.mp3");
    this.load.audio("lvl11-loop1", "assets/sfx/lvl11-loop1.mp3");
    this.load.audio("lvl11-loop2", "assets/sfx/lvl11-loop2.mp3");
    this.load.audio("lvl11-loop3", "assets/sfx/lvl11-loop3.mp3");
    this.load.audio("lvl11-restart", "assets/sfx/lvl11-restart.mp3");
    this.load.audio("lvl11-right", "assets/sfx/lvl11-right.mp3");
    this.load.audio("lvl11-unbounce", "assets/sfx/lvl11-unbounce.mp3");
    // ============ Music ====
    this.load.audio("lvl11-song", "assets/sfx/lvl5-songNotifications.mp3");
    this.load.audio("lvl11-3song", "assets/sfx/longBeep_.mp3");
    ...
    // ============ Sound ====
    this.load.audio("lvl13-aca", "assets/sfx/lvl13-addcheeseabove.mp3");
    this.load.audio("lvl13-bounce", "assets/sfx/lvl13-bounce.mp3");
    this.load.audio("lvl13-7jump", "assets/sfx/lvl7-jump_.mp3");
    this.load.audio("lvl13-left", "assets/sfx/lvl13-left.mp3");
    this.load.audio("lvl13-loop1", "assets/sfx/lvl13-loop1.mp3");
    this.load.audio("lvl13-loop2", "assets/sfx/lvl13-loop2.mp3");
    this.load.audio("lvl13-restart", "assets/sfx/lvl13-restart.mp3");
    this.load.audio("lvl13-right", "assets/sfx/lvl13-right.mp3");
    this.load.audio("lvl13-unbounce", "assets/sfx/lvl13-unbounce.mp3");
    // ============ Music ====
    this.load.audio("lvl13-song", "assets/sfx/lvl13-song.mp3");
    this.load.audio("lvl13-3song", "assets/sfx/longBeep_.mp3");
    this.load.audio("lvl13-traffic", "assets/sfx/trafficSong.mp3");
    this.load.audio("lvl13-7song", "assets/sfx/lvl7-songScreamandCalling.mp3");

    // LEVEL L ==== GAMEOVER/WIN LEVEL (substitute) ====
    this.load.image("lvll-bg", "assets/lvll-bg.png");
    this.load.image("lvll-cheese", "assets/cheese_busy.png");
