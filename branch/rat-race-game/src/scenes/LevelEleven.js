...
export default class LevelEleven extends Phaser.Scene {
  ...
  create() {
    ...
    //  MUSIC
    this.music = this.sound.add("lvl11-song");
    this.music.loop = true;
    this.music.play();
    this.beep = this.sound.add("lvl11-3song");
    this.beep.play();
    this.beep.loop = true;
    this.traffic = this.sound.add("lvl11-traffic");
    ...
    this.input.keyboard.once("keydown-L", () => {
      ...
      this.music.stop("lvl11-song");
      this.beep.stop("lvl11-song");
      this.traffic.stop("lvl11-song");
    });
  ...
  update() {
    ...
    if (vy > 0 && this.player.texture.key != "lvl5-ratj") {
      ...
      this.cameras.main.shake(500);
      this.sound.play("lvl11-unbounce");
    }
    ...
    if (this.cursors.left.isDown && !touchingDown) {
      ...
      this.sound.play("lvl11-left");
    } else if (this.cursors.right.isDown && !touchingDown) {
      this.player.setVelocityX(400);
      this.sound.play("lvl11-right");
    } else {
    ...
    if (this.player.y < this.n * -100) {
      this.pbackground.setY(this.n * -200);
      this.n += 1;
      this.pbackground.setX(480);
      this.sound.play("lvl11-loop3");
    }
