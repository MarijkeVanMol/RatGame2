...
export default class LevelTwelve extends Phaser.Scene {
  ...
  init() {
    this.cheesesCollected = 605;
    this.CheeseCount = 605;
  }

  create() {
    console.log("create level 12");
    ...
    //  PLAYER
    this.player = this.physics.add.sprite(240, 320, "lvl12-rat").setScale(0.1);
    ...
    this.input.keyboard.once("keydown-N", () => {
      this.scene.start("levelThirteen");
    });
  }
  ...
  addCheeseAbove(player) {
    ...
    this.cheeses.create(cheeseX, cheeseY, "lvl12-cheese").setScale(0.1);
  }
